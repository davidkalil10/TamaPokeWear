...
|---|---|---|
| 📺 **IPTV Smart Cast** | A premium multi-platform IPTV player (Meta Quest, Android, Android TV, WearOS, Samsung TV, Windows, Steam) with a standout exclusive feature: cross-platform **Watch Together** — watch live channels in real time with friends remotely, synced frame-by-frame across any device. | [GitHub](https://github.com/davidkalil10/IPTV-Smart-Cast-Website) |
